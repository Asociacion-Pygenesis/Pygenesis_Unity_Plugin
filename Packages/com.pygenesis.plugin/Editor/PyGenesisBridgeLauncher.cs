...
public static class PyGenesisBridgeLauncher
{
    ...
    /// <summary>Comprueba script puente, manifiesto completo de binarios llama.cpp y GGUF.</summary>
    public static bool TryPreflight(out string message)
    {
        return PyGenesisDependencyChecker.TryBuildBridgePreflightMessage(out message);
    }
